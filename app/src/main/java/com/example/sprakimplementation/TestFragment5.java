...
import com.example.sprakimplementation.databinding.FragmentTest5Binding;
...
public class TestFragment5 extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        botonSiguiente.setOnClickListener(v -> navController.navigate(R.id.action_testFragment52_to_finalTestFragment));
